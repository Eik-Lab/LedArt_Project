...
https://github.com/ajavamind/arduino/blob/master/LED-matrix/Fire/Fire.ino
*/

#include <Adafruit_NeoPixel.h>


#define N_PIXELS  64  // Number of pixels

#define M_WIDTH 8  // matrix width
#define M_HEIGHT 8 // matrix height
#define LED_PIN    5 // NeoPixel LED strand data

unsigned char reduce = 2; // used to reduce brightness
...
void setPixel(unsigned char x, unsigned char y, unsigned char colorR, unsigned char colorG, unsigned char colorB){
  ...
  strip.setPixelColor(M_WIDTH*(M_HEIGHT-y-1) + x, colorR/reduce, 5*colorG/reduce, colorB/reduce);
}
